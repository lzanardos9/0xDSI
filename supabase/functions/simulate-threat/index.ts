...
12. "monteCarloRuns": Array of exactly 100 objects { "runId": number (1-100), "feasibilityScore": number (0-100), "detectionTimeMinutes": number, "attackSuccessRate": number (0-1), "defenseHoldRate": number (0-1) }. These must form a realistic statistical distribution: use a normal distribution centered around the main feasibility score with standard deviation of ~10-15 points. Include 5-10 outlier runs that deviate significantly (simulating edge cases). The detectionTimeMinutes should correlate inversely with defenseHoldRate. attackSuccessRate and defenseHoldRate should sum to approximately 1.0 with minor variance.

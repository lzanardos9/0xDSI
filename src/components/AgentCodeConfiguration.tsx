...
import { Code, Settings, FileCode, Terminal, Box, Database, Workflow, Copy, Check, Brain, Cpu } from 'lucide-react';
...
# This is a placeholder for custom agents`;
  ...
  return (
    <div className="h-full flex bg-slate-950">
      {/* Agent Sidebar */}
      <div className="w-80 border-r border-slate-800 overflow-y-auto bg-slate-900/50">
        <div className="p-4 border-b border-slate-800">
          <h3 className="text-white font-semibold flex items-center space-x-2">
            <Box className="w-5 h-5 text-blue-500" />
            <span>Agent Bricks</span>
          </h3>
          <p className="text-slate-400 text-xs mt-1">Select an agent to view implementation</p>
        </div>
        <div className="p-2 space-y-1">
          {agents.map((agent) => (
            ...
            >
              ...
              <div className="text-xs opacity-75 mt-1">{agent.type}</div>
              <div className="text-xs opacity-60 mt-1 flex items-center space-x-1">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="flex items-center space-x-4 mt-3">
                    ...
                    <span className="px-3 py-1 bg-purple-500/20 text-purple-400 rounded text-xs font-semibold border border-purple-500/30">

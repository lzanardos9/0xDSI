...
export const CATALOG_CONNECTORS: CatalogConnector[] = [
  ...
  { id: 'casb-1', name: 'Netskope', vendor: 'Netskope', category: 'casb', description: 'Inline CASB and ZTNA with real-time data and threat protection for cloud apps, web, and private apps.', status: 'connected', protocol: 'REST API v2 / Syslog / Log Shipper' },

...
# MAGIC %md
# MAGIC # Dazzle SOC Platform -- Complete Databricks Migration
# MAGIC ## Single-Notebook Full Infrastructure Setup
# MAGIC - 202 Delta Lake tables across 17 domain schemas
# MAGIC - Unity Catalog: soc_platform
# MAGIC - Medallion architecture ready (Bronze/Silver/Gold)
# MAGIC - Vector search preparation
# MAGIC - Data migration from Supabase PostgreSQL
# MAGIC - Estimated runtime: 30-45 minutes

# COMMAND ----------

# Configuration
CATALOG = "soc_platform"
SUPABASE_URL = dbutils.widgets.text("supabase_url", "", "Supabase PostgreSQL URL")
SUPABASE_PASSWORD = dbutils.secrets.get(scope="soc-secrets", key="supabase-password")
...
USE CATALOG soc_platform;""")


# COMMAND ----------

spark.sql("""-- Create all 17 domain schemas
CREATE SCHEMA IF NOT EXISTS soc_platform.core_siem;
CREATE SCHEMA IF NOT EXISTS soc_platform.threat_intel;
CREATE SCHEMA IF NOT EXISTS soc_platform.threat_modeling;
CREATE SCHEMA IF NOT EXISTS soc_platform.user_analytics;
CREATE SCHEMA IF NOT EXISTS soc_platform.incident_response;
CREATE SCHEMA IF NOT EXISTS soc_platform.compliance;
CREATE SCHEMA IF NOT EXISTS soc_platform.malware_sandbox;
CREATE SCHEMA IF NOT EXISTS soc_platform.red_team;
CREATE SCHEMA IF NOT EXISTS soc_platform.network_security;
CREATE SCHEMA IF NOT EXISTS soc_platform.ai_agents;
CREATE SCHEMA IF NOT EXISTS soc_platform.correlation_engine;
CREATE SCHEMA IF NOT EXISTS soc_platform.data_connectors;
CREATE SCHEMA IF NOT EXISTS soc_platform.llm_security;
CREATE SCHEMA IF NOT EXISTS soc_platform.search_infra;
CREATE SCHEMA IF NOT EXISTS soc_platform.platform_config;
CREATE SCHEMA IF NOT EXISTS soc_platform.ocsf;
CREATE SCHEMA IF NOT EXISTS soc_platform.internal_services;""")
...
-- Table: raw_event_buffer (12 columns)
...
-- Table: raw_security_events (13 columns)
...
spark.sql("""-- ============================================================================
-- Schema: threat_intel (17 tables)
-- ============================================================================
-- Table: cisa_kev_catalog (13 columns)
...
-- Table: dark_web_corporate_alerts (15 columns)
...
-- Table: dark_web_forum_posts (18 columns)
...
-- Table: dark_web_forum_sources (12 columns)
...
-- Table: dark_web_intelligence (17 columns)
...
-- Table: dark_web_threat_marketplace (22 columns)
...
-- Table: feed_sync_logs (12 columns)
...
-- Table: historical_attacks (26 columns)
...
-- Table: osint_sources (17 columns)
...
-- Table: phishing_dataset (29 columns)
...
-- Table: stix_indicators (19 columns)
...
-- Table: threat_actor_attribution (22 columns)
...
-- Table: threat_campaigns (16 columns)
...
-- Table: threat_intelligence_sources (15 columns)
...
-- Table: zero_day_candidates (21 columns)
...
spark.sql("""-- ============================================================================
-- Schema: threat_modeling (8 tables)
-- ============================================================================
-- Table: escalation_rules (13 columns)
...
-- Table: event_priority_calculations (16 columns)
...
-- Table: predictive_threat_models (20 columns)
...
-- Table: threat_escalation_formulas (14 columns)
...
-- Table: threat_mitigations (12 columns)
...
-- Table: threat_model_sources (7 columns)
...
-- Table: threat_models (17 columns)
...
-- Table: threat_scenarios (15 columns)
...
spark.sql("""-- ============================================================================
-- Schema: user_analytics (18 tables)
-- ============================================================================
-- Table: auth_attempts (11 columns)
...
-- Table: behavior_correlations (10 columns)
...
-- Table: behavioral_baselines (12 columns)
...
-- Table: cross_platform_behavioral_patterns (23 columns)
...
-- Table: demo_passwords (5 columns)
...
-- Table: email_behavioral_analysis (29 columns)
...
-- Table: interaction_linguistic_analysis (24 columns)
...
-- Table: meeting_behavioral_analysis (29 columns)
...
-- Table: psychological_risk_factors (17 columns)
...
-- Table: slack_behavioral_analysis (28 columns)
...
-- Table: teams_behavioral_analysis (16 columns)
...
-- Table: user_audit_log (13 columns)
...
-- Table: user_behavior_events (14 columns)
...
-- Table: user_clearances (18 columns)
...
-- Table: user_profiles (42 columns)
...
-- Table: user_psychological_profiles (42 columns)
...
-- Table: user_risk_assessments (10 columns)
...
spark.sql("""-- ============================================================================
-- Schema: incident_response (4 tables)
-- ============================================================================
-- Table: n8n_workflows (13 columns)
...
-- Table: response_actions (10 columns)
...
-- Table: workflow_executions (11 columns)
...
-- Table: workflow_triggers (13 columns)
...
spark.sql("""-- ============================================================================
-- Schema: compliance (10 tables)
-- ============================================================================
-- Table: access_control_matrix (12 columns)
...
-- Table: business_impact_analyses (17 columns)
...
-- Table: compliance_assessments (16 columns)
...
-- Table: compliance_controls (13 columns)
...
-- Table: compliance_evidence (13 columns)
...
-- Table: compliance_frameworks (9 columns)
...
-- Table: compliance_gaps (14 columns)
...
-- Table: compliance_mappings (14 columns)
...
-- Table: contract_obligations (15 columns)
...
-- Table: risk_assessments (19 columns)
...
spark.sql("""-- ============================================================================
-- Schema: malware_sandbox (12 tables)
-- ============================================================================
-- Table: ai_analysis_jobs (12 columns)
...
-- Table: ai_analysis_results (29 columns)
...
-- Table: file_operations (19 columns)
...
-- Table: kernel_activity (21 columns)
...
-- Table: malware_samples (22 columns)
...
-- Table: malware_sandbox_results (24 columns)
...
-- Table: memory_analysis (20 columns)
...
-- Table: network_behavior (23 columns)
...
-- Table: process_behavior (21 columns)
...
-- Table: registry_operations (15 columns)
...
-- Table: sandbox_sessions (22 columns)
...
spark.sql("""-- ============================================================================
-- Schema: red_team (12 tables)
-- ============================================================================
-- Table: adversarial_training_data (15 columns)
...
-- Table: agent_pentest_sessions (13 columns)
...
-- Table: ai_generated_tools (14 columns)
...
-- Table: attack_chains (16 columns)
...
-- Table: detected_attack_sequences (22 columns)
...
-- Table: fuzzing_campaigns (13 columns)
...
-- Table: fuzzing_crashes (23 columns)
...
-- Table: fuzzing_results (10 columns)
...
-- Table: pentest_campaigns (16 columns)
...
-- Table: pentest_exploits (21 columns)
...
-- Table: pentest_findings (12 columns)
...
-- Table: pentest_targets (19 columns)
...
spark.sql("""-- ============================================================================
-- Schema: network_security (11 tables)
-- ============================================================================
-- Table: asset_registry (15 columns)
...
-- Table: asset_vulnerabilities (14 columns)
...
-- Table: dlp_detections (12 columns)
...
-- Table: nist_nvd_vulnerabilities (16 columns)
...
-- Table: packet_captures (13 columns)
...
-- Table: personnel_tracking (10 columns)
...
-- Table: physical_asset_vulnerabilities (12 columns)
...
-- Table: physical_security_events (12 columns)
...
-- Table: physical_zones (7 columns)
...
spark.sql("""-- ============================================================================
-- Schema: ai_agents (16 tables)
-- ============================================================================
-- Table: agent_learning_feedback (10 columns)
...
-- Table: ai_agent_activity (9 columns)
...
-- Table: embedding_models (7 columns)
...
-- Table: foundation_models (15 columns)
...
-- Table: hedwick_model_registry (21 columns)
...
-- Table: mlflow_experiments (7 columns)
...
-- Table: mlflow_traces (20 columns)
...
-- Table: model_evaluations (23 columns)
...
-- Table: model_feedback (13 columns)
...
-- Table: model_fine_tuning_jobs (23 columns)
...
-- Table: model_monitoring_metrics (22 columns)
...
-- Table: model_serving_endpoints (19 columns)
...
-- Table: soc_automation_metrics (10 columns)
...
spark.sql("""-- ============================================================================
-- Schema: correlation_engine (24 tables)
-- ============================================================================
-- Table: cep_pattern_matches (14 columns)
...
-- Table: correlation_rule_matches (8 columns)
...
-- Table: correlation_rules (17 columns)
...
-- Table: discovered_patterns (23 columns)
...
-- Table: discovery_profiles (16 columns)
...
-- Table: discovery_snapshots (13 columns)
...
-- Table: entity_resolution (9 columns)
...
-- Table: graph_communities (14 columns)
...
-- Table: graph_correlations (17 columns)
...
-- Table: graph_patterns (18 columns)
...
-- Table: graph_processing_jobs (13 columns)
...
-- Table: graph_stream_windows (13 columns)
...
-- Table: pattern_baselines (12 columns)
...
-- Table: pattern_investigations (10 columns)
...
-- Table: streaming_graph_edges (13 columns)
...
-- Table: streaming_graph_vertices (12 columns)
...
-- Table: threat_graph_edges (13 columns)
...
-- Table: threat_graph_nodes (13 columns)
...
-- Table: threat_hunt_queries (14 columns)
...
-- Table: vector_correlation_rules (17 columns)
...
-- Table: vector_correlations (12 columns)
...
spark.sql("""-- ============================================================================
-- Schema: data_connectors (10 tables)
-- ============================================================================
-- Table: bytecode_instrumentation (20 columns)
...
-- Table: code_pattern_analysis (20 columns)
...
-- Table: connector_alerts (14 columns)
...
-- Table: connector_events (15 columns)
...
-- Table: connector_telemetry (15 columns)
...
-- Table: data_connectors (21 columns)
...
-- Table: intercepted_functions (17 columns)
...
-- Table: memory_snapshots (15 columns)
...
-- Table: string_intercepts (19 columns)
...
spark.sql("""-- ============================================================================
-- Schema: llm_security (11 tables)
-- ============================================================================
-- Table: ai_gateway_policies (7 columns)
...
-- Table: ai_gateway_requests (19 columns)
...
-- Table: ai_security_incidents (21 columns)
...
-- Table: communication_sources (16 columns)
...
-- Table: document_uploads (15 columns)
...
-- Table: extracted_assets (15 columns)
...
-- Table: llm_interactions (29 columns)
...
-- Table: llm_risk_incidents (21 columns)
...
-- Table: llm_risk_profiles (32 columns)
...
-- Table: llm_risk_rules (16 columns)
...
-- Table: psychological_profile_evidence (16 columns)
...
spark.sql("""-- ============================================================================
-- Schema: search_infra (8 tables)
-- ============================================================================
-- Table: full_text_search_config (9 columns)
...
-- Table: lucene_indices (14 columns)
...
-- Table: lucene_search_cache (11 columns)
...
-- Table: lucene_shards (12 columns)
...
-- Table: partition_metadata (13 columns)
...
-- Table: query_performance_stats (11 columns)
...
-- Table: query_routing_rules (8 columns)
...
-- Table: search_performance_metrics (10 columns)
...
spark.sql("""-- ============================================================================
-- Schema: platform_config (19 tables)
-- ============================================================================
-- Table: active_lists (11 columns)
...
-- Table: correlation_queue (11 columns)
...
-- Table: custom_reports (9 columns)
...
-- Table: data_optimization_jobs (15 columns)
...
-- Table: databricks_sync_status (11 columns)
...
-- Table: enrichment_queue (10 columns)
...
-- Table: enrichment_sources (16 columns)
...
-- Table: event_parsers (14 columns)
...
-- Table: parsing_queue (12 columns)
...
-- Table: processing_stats (10 columns)
...
-- Table: report_executions (14 columns)
...
-- Table: report_schedules (12 columns)
...
-- Table: session_correlations (13 columns)
...
-- Table: session_list_entries (18 columns)
...
-- Table: session_list_rules (14 columns)
...
-- Table: session_lists (12 columns)
...
-- Table: stream_partitions (9 columns)
...
-- Table: streaming_pipelines (13 columns)
...
-- Table: system_settings (48 columns)
...
spark.sql("""-- ============================================================================
-- Schema: ocsf (6 tables)
-- ============================================================================
-- Table: diagram_entities (14 columns)
...
-- Table: ocsf_attributes (7 columns)
...
-- Table: ocsf_categories (5 columns)
...
-- Table: ocsf_enrichments (5 columns)
...
-- Table: ocsf_event_classes (8 columns)
...
-- Table: ocsf_source_mappings (9 columns)
...
spark.sql("""-- ============================================================================
-- Schema: internal_services (8 tables)
-- ============================================================================
-- Table: alkami_inference_service (22 columns)
...
-- Table: bolt_gpu_training (25 columns)
...
-- Table: brickstore_cache (11 columns)
...
-- Table: cowboy_notebooks (17 columns)
...
-- Table: db_apps_registry (22 columns)
...
-- Table: lakebase_sync_jobs (14 columns)
...
-- Table: turi_metadata_registry (17 columns)
...
-- Table: zerobus_commits (13 columns)
...
# MAGIC Unified view joining events with OCSF classification metadata.
...
# MAGIC %md
# MAGIC ## Optimization -- OPTIMIZE + ZORDER for Key Tables

# COMMAND ----------

spark.sql("""OPTIMIZE soc_platform.core_siem.events ZORDER BY (severity, source);

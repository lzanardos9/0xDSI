...
echo "    1. Set DATABRICKS_WAREHOUSE_ID in App environment settings"
echo "    2. Wait for initial_setup job to finish (creates 70+ tables)"
echo "    3. Configure data connectors (Kafka, Event Hub, etc.)"
echo "    4. Start streaming jobs from Workflows UI"
echo ""
echo "  Deployed components:"
echo "    - Databricks App (React + FastAPI + Genie, workspace SSO)"
echo "    - 40+ Workflow Jobs (28 agents + correlation + ML + streaming)"
echo "    - DLT Pipeline (Bronze/Silver/Gold medallion)"
echo "    - 51 Notebooks (agents, correlation, detection, ML, ingestion)"
echo "    - 70+ Delta Lake tables in Unity Catalog"
